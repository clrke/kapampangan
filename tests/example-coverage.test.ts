...
const KP_BACKLOG = [
  ...
  'aso', 'ating', 'atlung', 'atneng', 'atulan', 'bag', 'balat', 'balik',
  'basaen', 'bayaran', 'bayung', 'bengi-bengi', 'binayad', 'binie',
  'binura', 'biyaya', 'bukasan', 'bulak',
  ...
  'ipil', 'kalagu', 'kaming', 'kamut', 'kanaku',
  'kanto', 'kanyaman', 'kapiganakan', 'karela', 'karimla',
  'kasuyuan', 'kata', 'kaya', 'keku', 'keraklan',
  'kulambung', 'kuwarta', 'kwentu', 'labas', 'labhan', 'labuad', 'lagyan',
  ...
  'malagung', 'malagus', 'malake', 'malat', 'mali', 'maitum', 'malaba', 'malipad',
  'maluad', 'malugay', 'mamangan', 'mamaya', 'mangailangan', 'manghinga', 'mangutang',
  ...
  'muran', 'múra', 'nabayad', 'naka', 'naku', 'nang', 'nanung',
  'napalubus', 'napasar', 'napuputian', 'naulagang', 'ngening', 'opisina',
  ...
  'malapad', 'puerta', 'pun', 'pung', 'raku', 'ri', 'sagiwa', 'sake',
  'sangdominggo', 'sasara', 'seli', 'sinadsad', 'sinali',
  'sinalita', 'sinaul', 'suluk', 'susulat', 'susunud',
  'talaturung', 'tanaman', 'tang', 'temperatura',
