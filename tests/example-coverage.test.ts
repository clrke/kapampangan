...
const KP_BACKLOG = [
  ...
  'daka', 'dake', 'dakul', 'daká', 'dapat', 'dating', 'dayat', 'deni', 'dening',
  ...
  'ipil', 'kailangan', 'kalagu', 'kaming', 'kamu', 'kamut', 'kanaku',
  'kanto', 'kanyaman', 'kapiganakan', 'karela', 'kareni', 'karimla', 'karing', 'kasal',
  'kasuyuan', 'kata', 'kaya', 'kayabe', 'keku', 'keraklan', 'keta', 'keti', 'ko',
  ...
  'marelax', 'masikan', 'masyadu', 'mataba', 'mative', 'matudtud', 'matulid',
