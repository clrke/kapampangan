...
const KP_BACKLOG = [
  ...
  'hugasan', 'huminga', 'i', 'ibili', 'ibinie', 'ibiye', 'ibuklat', 'ibyan', 'ilaga', 'ina', 'inda', 'ining',
  'ipil', 'itik', 'kaibigan', 'kailangan', 'kakanán', 'kaklase', 'kalagu', 'kaming', 'kamu', 'kamut', 'kanaku',
  'kanimo', 'kanto', 'kanyaman', 'kapampangan', 'kapiganakan', 'karela', 'kareni', 'karimla', 'karing', 'kasal',
  'kasuyuan', 'kata', 'kaya', 'kayabe', 'kekan', 'keku', 'keng', 'keraklan', 'keta', 'keti', 'klase', 'ko',
  'kotse', 'kulambung', 'kumain', 'kung', 'kuwarta', 'kwarto', 'kwentu', 'labas', 'labhan', 'labuad', 'lagyan',
  'lako', 'lang', 'langit', 'lapis', 'larawan', 'leksyon', 'libro', 'libru', 'liham', 'linggu', 'linisan',
  'lubu-lubu', 'lulusong', 'lumabas', 'lumakad', 'lumalukbad', 'lumaluksad', 'lumwal', 'luto', 'lutuan',
  'mabait', 'mabala', 'mabangis', 'mabatu', 'mabeyak', 'mabilisan', 'magandang', 'magbayad', 'magbebenta',
  'magbibigay', 'maging', 'magkayli', 'magluto', 'magobra', 'magpakalugud', 'magsalita', 'maguimbal',
  'magwanan', 'mainit', 'makapantag', 'makaputi', 'makatandang', 'makatua', 'makipagusap', 'makita', 'makmak',
  'mako', 'makulit', 'malagung', 'malagus', 'malake', 'malaking', 'malambat', 'malapit', 'malat', 'malayo',
  'mali', 'maliksi', 'malipad', 'maliwanag', 'malupit', 'mamangan', 'mamaya', 'mangailangan', 'mangutang',
  'maniarikit', 'mansanas', 'mapagmahal', 'mapalad', 'mapandaig', 'mapandilu', 'mapula', 'mapunta', 'maralas',
  'marelax', 'masileng', 'masipag', 'masyadu', 'mataba', 'matamis', 'mative', 'matudtud', 'matulid', 'me',
  'mekita', 'mekublan', 'mengébun', 'meturan', 'meyari', 'mi', 'miboto', 'mika', 'mipapatudtud', 'miras', 'mo',
  'muran', 'musika', 'múra', 'nabayad', 'nagluto', 'nagtutuk', 'nagtuturu', 'naintindihan', 'naka',
  'nakalukluk', 'naku', 'naman', 'namu', 'nang', 'nanung', 'napalubus', 'napasar', 'napuputian', 'narinig',
  'nasa', 'nasan', 'naulagang', 'ne', 'ngan', 'ngening', 'opisina', 'paa', 'pagkain', 'pagsarian', 'pakisuyo',
  'palisan', 'palitan', 'palwal', 'pamagmula', 'pamagsabyan', 'pamasahe', 'panahon', 'panalung', 'pananim',
  'panaun', 'papunta', 'pari', 'parsala', 'paru-paro', 'pasalan', 'paulit-ulit', 'pelikula', 'pero', 'pila',
  'pintuan', 'piso', 'pista', 'plasa', 'pong', 'pritung', 'puerta', 'pulo', 'pumunta', 'pun', 'pung', 'puno',
  'punta', 'puso', 'raku', 'ri', 'ring', 'sa', 'saan', 'saging', 'sagiwa', 'sake', 'sala', 'sana',
  'sangdominggo', 'sarad', 'sasara', 'sasaya', 'seli', 'sige', 'silya', 'simbahan', 'sinadsad', 'sinali',
  'sinalita', 'sinaul', 'sukli', 'sulud', 'suluk', 'susi', 'susulat', 'susunud', 'ta', 'taku', 'talaga',
  'talaturung', 'tana', 'tanaman', 'tang', 'tao', 'temperatura', 'tiangge', 'tibuk', 'tinape', 'trabahu',
  'tubig', 'tulung', 'tulungan', 'tumakbu', 'tumawag', 'tutuki', 'tutulung', 'tutulungan', 'umuran', 'utang',
  'wala', 'wari', 'yan', 'yang', 'yata', 'yu',
]
