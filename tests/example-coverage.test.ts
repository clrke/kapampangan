...
const KP_BACKLOG = [
  ...
  'kasuyuan', 'kata', 'kaya', 'kayabe', 'keku', 'keraklan', 'keta', 'keti',
  ...
  'napalubus', 'napasar', 'napuputian', 'naulagang', 'ne', 'ngan', 'ngening', 'opisina',
  'pagsarian', 'pakisuyo', 'palayan', 'palisan', 'palitan', 'palwal', 'pamagmula', 'pamagsabyan',
  ...
  'sangdominggo', 'sarad', 'sasara', 'seli', 'sige', 'sinadsad', 'sinali',
