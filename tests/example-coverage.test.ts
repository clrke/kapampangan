...
const KP_BACKLOG = [
  ...
  'dinatang', 'dingna', 'dintang', 'gagawan',
  'gagewan', 'gamitan', 'gamiton', 'gawan', 'ginawa', 'gumawa',
  'hugasan', 'ibili', 'ibinie', 'ibiye', 'ibuklat', 'ibyan', 'ining',
  'kaming',
  'keku',
  'kuwarta', 'labas', 'lagyan',
  'laro', 'linisan',
  ...
  'makaputi', 'makatua', 'makatuang', 'makilabas', 'makita', 'mako', 'makulit',
  'maitum', 'malaba', 'malipad',
  ...
  'pagsarian', 'palisan', 'palitan', 'pamagmula', 'pamagsabyan',
  'pane-neng',
  'pasalan', 'pong', 'pritung',
  'pung',
  'sasara', 'sinadsad', 'sinali',
