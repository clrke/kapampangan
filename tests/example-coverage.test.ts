...
const KP_BACKLOG = [
  ...
  'balita', 'banua', 'basaen', 'bayung', 'bengi-bengi', 'bibili', 'binayad', 'binie', 'bintana',
  ...
  'mabala', 'mabangis', 'mabatu', 'mabeyak', 'mabilisan', 'magbie', 'magbayad', 'magbebenta',
  'maging', 'magkayli', 'magluto', 'magobra', 'magpakalugud', 'magsalita', 'maguimbal',
  'magwanan', 'mainit', 'makapantag', 'makaputi', 'makatuang', 'makatua', 'makipagusap', 'makita', 'makmak',
  'mako', 'makulay', 'makulit', 'malagung', 'malagus', 'malake', 'malambat', 'malapit', 'malat', 'malayo',
  'mali', 'maliksi', 'malipad', 'maliwanag', 'maluad', 'malupit', 'mamangan', 'mamaya', 'mangailangan', 'mangutang',
  'maniarikit', 'mansanas', 'mapaglugud', 'mapalad', 'mapandaig', 'mapandilu', 'mapula', 'mapunta', 'maralas',
  'marelax', 'masileng', 'masipag', 'masyadu', 'mataba', 'mative', 'matudtud', 'matulid', 'me',
  'masikan', 'mekita', 'mekublan', 'mengébun', 'meturan', 'meyari', 'mi', 'miboto', 'mika', 'migluto', 'migtutuk', 'mipapatudtud', 'miras', 'mo',
  'muran', 'musika', 'múra', 'nabayad', 'nagluto', 'nagtuturu', 'naintindihan', 'naka',
  'nakalukluk', 'naku', 'naman', 'namu', 'nang', 'nanung', 'napalubus', 'napasar', 'napuputian', 'narinig',
  'nasa', 'naulagang', 'ne', 'ngan', 'ngening', 'opisina', 'paa', 'pagkain', 'pagsarian', 'pakisuyo',
  'palayan', 'palisan', 'palitan', 'palwal', 'pamagmula', 'pamagsabyan', 'pamasahe', 'panahon', 'panalung', 'pananim',
  'panaun', 'papunta', 'pari', 'parsala', 'paru-paro', 'pasalan', 'paulit-ulit', 'pelikula', 'pero', 'pila',
  'pintuan', 'piso', 'pista', 'plasa', 'pong', 'pritung', 'puerta', 'pumunta', 'pun', 'pung', 'puno',
  'punta', 'puso', 'raku', 'ri', 'ring', 'sa', 'saan', 'saging', 'sagiwa', 'sake', 'sala', 'sana',
  'sangdominggo', 'sarad', 'sasara', 'seli', 'sige', 'silya', 'simbahan', 'sinadsad', 'sinali',
  'sinalita', 'sinaul', 'sukli', 'sulud', 'suluk', 'susi', 'susulat', 'susunud', 'ta', 'taku', 'talaga',
  'talaturung', 'tana', 'tanaman', 'tang', 'tao', 'tapos', 'temperatura', 'tiangge', 'tibuk', 'tinape', 'trabahu',
  'tubig', 'tulog', 'tulungan', 'tumakbu', 'tumawag', 'tutuki', 'tutulung', 'tutulungan', 'umuran', 'utang',
