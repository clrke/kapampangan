...
const KP_BACKLOG = [
  ...
  'balita', 'banua', 'basaen', 'bayung', 'bengi-bengi', 'binayad', 'binie', 'bintana',
  ...
  'kotse', 'kulambung', 'kung', 'kuwarta', 'kwarto', 'kwentu', 'labas', 'labhan', 'labuad', 'lagyan',
  ...
  'muran', 'musika', 'múra', 'nabayad', 'naintindihan', 'naka', 'naku', 'naman', 'namu', 'nang', 'nanung',
  ...
  'paru-paro', 'pasalan', 'pelikula', 'pero', 'pila', 'pintuan', 'piso', 'pista', 'plasa', 'pong', 'pritung',
  'puerta', 'pun', 'pung', 'puno', 'puso', 'raku', 'ri', 'ring', 'sa', 'saging', 'sagiwa', 'sake', 'sala',
  'sana', 'sangdominggo', 'sarad', 'sasara', 'seli', 'sige', 'silya', 'simbahan', 'sinadsad', 'sinali',
  'sinalita', 'sinaul', 'sukli', 'sulud', 'suluk', 'susi', 'susulat', 'susunud', 'ta', 'taku', 'talaga',
  'talaturu', 'talaturung', 'tana', 'tanaman', 'tang', 'tao', 'tapos', 'temperatura', 'tiangge', 'tibuk',
  'tinape', 'trabahu', 'tubig', 'tulog', 'tulungan', 'tumakbu', 'tumawag', 'tutuki', 'tutulung', 'tutulungan',
