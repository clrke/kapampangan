...
const KP_BACKLOG = [
  ...
  'kulambung', 'kuwarta', 'labas', 'labhan', 'labuad', 'lagyan',
  'lako', 'linisan',
  ...
  'pamasahe', 'panalung', 'panaun', 'pane-neng', 'pari',
