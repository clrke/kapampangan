...
const KP_BACKLOG = [
  ...
  'kanto', 'kanyaman', 'kapiganakan', 'karela', 'karimla', 'kasal',
  ...
  'malagung', 'malagus', 'malake', 'malat', 'mali', 'malipad',
  ...
  'sinalita', 'sinaul', 'sukli', 'suluk', 'susulat', 'susunud',
  'talaturung', 'tanaman', 'tang', 'tapos', 'temperatura',
