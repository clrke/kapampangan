...
const KP_BACKLOG = [
  ...
  'daka', 'dake', 'daká', 'dating', 'dayat', 'dening',
  ...
  'ipil', 'kalagu', 'kaming', 'kanaku',
  'kapiganakan',
  'kasuyuan', 'kata', 'keku', 'keraklan',
  ...
  'malagung', 'malagus', 'malake', 'malat', 'maitum', 'malaba', 'malipad',
